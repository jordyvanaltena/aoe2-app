<template>
    <div class="unit shadow">
        ...
        <div class="unit-wrap">
            <img
                class="unit-icon"
                :src="require(`../assets/unit-placeholder.jpg`)"
                alt=""
            />
            <div class="stat-wrap">
                <p v-if="attack" class="unit-stat">
                    <span class="font-weight-bold"> Attack:</span> {{ attack }}
                </p>
                <p v-if="armor" class="unit-stat">
                    <span class="font-weight-bold"> Armor:</span> {{ armor }}
                </p>
                <p v-if="line_of_sight" class="unit-stat">
                    <span class="font-weight-bold"> LOS:</span>
                    {{ line_of_sight }}
                </p>
                <p v-if="range" class="unit-stat">
                    <span class="font-weight-bold"> range:</span> {{ range }}
                </p>
                <p v-if="accuracy" class="unit-stat">
